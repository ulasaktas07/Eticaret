...
namespace Eticaret.WebUI.Areas.Admin.Controllers
{
    ...
    public class AddressController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,City,District,OpenAddress,IsActive,IsBillingAddress,IsDeliveryAddress,CreateDate,AppUserId")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
