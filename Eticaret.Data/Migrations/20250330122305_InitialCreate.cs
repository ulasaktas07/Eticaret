    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 3, 30, 15, 23, 3, 856, DateTimeKind.Local).AddTicks(693), null, null, true, true, "Elektronik", 1, 0 },
                    { 2, new DateTime(2025, 3, 30, 15, 23, 3, 856, DateTimeKind.Local).AddTicks(733), null, null, true, true, "Bilgisayar", 2, 0 }
                });

            migrationBuilder.InsertData(
                table: "MyProperty",
                columns: new[] { "Id", "CreateDate", "Email", "IsActive", "IsAdmin", "Name", "Password", "Phone", "Surname", "UserGuid", "UserName" },
                values: new object[] { 1, new DateTime(2025, 3, 30, 15, 23, 3, 853, DateTimeKind.Local).AddTicks(9841), "deneme@gmail.com", true, true, "Admin", "123", null, "Admin", new Guid("5f9a6147-8af3-4dd8-aaea-3412819a840b"), "Admin" });
